							...
							<div class="col-xs-6 col-md-3">
								<div class="album">
									...
									{% if album.getAlbumThumbnail.path is null %}
										<img src="{{ baseUrl }}{{ public }}assets/icons/Album.svg" alt="Album photos" class="album__thumb"/></a>
									{% else %}
										<img src="{{ album.getAlbumThumbnail.path }}" alt="Album photos" class="album__thumb"/>
									{% endif %}
								</div>
