		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="{{ urlFor('upload.post') }}" method="post" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
						<div class="form-group{{ (errors.has('img_title')) ? ' has-error' : '' }}">
							<label for="inputEmail3" class="col-sm-2 control-label">Photo Title</label>
							<div class="col-sm-10">
								<input type="text" name="img_title" class="form-control" id="inputEmail3" placeholder="Enter your Photo Title">
